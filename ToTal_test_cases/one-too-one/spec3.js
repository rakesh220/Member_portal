//1) Send any image file in one-to-one chat
describe('one-to-one chat cases', ()=> {
    it('Send image files to other users', ()=> {
...
browser.driver.sleep(10000);
 var a=element(by.xpath('//*[@id="default"]/div[1]/ul/li[3]/aadhya-chat-message/div/div/div'));
browser.driver.sleep(20000);
